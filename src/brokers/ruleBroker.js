...
// plugins.hayD-CAF.brokers.ruleBroker.
 ...
 * @return {object} A JSON object that contains an array of function objects that map function name to function cal or all the business rules.
 * @author Seth Hollingsead
 * @date 2023/04/03
 */
